...
COLORS = {
    ...
    'background_header': '#D5E5F3',  # Header background color with logo
    
    # Borders
    "border": "#A0B4C6",  # Default general border
    "border_light": "#A0B4C6",
    ...
    # Accents
    "accent": "#5385B7",         # Main accent color (same as button_primary)
    "accent_light": "#659BD1",    # Lighter version for hover states (same as button_primary_hover)
    ...
    "link": "#0066cc",  # Added: color for links
    'text_secondary': '#6c757d',
    
    # Alarms
    "alarm_normal": "#FFA500",  # Orange
    "alarm_observation": "#9370DB",  # Soft purple
    'hover_row': '#f8f9fa',
    'triage1': '#ff0000',  # Red
    'triage2': '#ffa500',  # Orange
    'triage3': '#ffff00',  # Yellow
    'triage4': '#008000',  # Green
    'triage5': '#0000ff',  # Blue
    'triage_no': '#808080',  # Gray
}
...
TABLE_STYLES_UPDATED = {
    "main": f"""
        QTableWidget {{
            ...
            border-radius: {BORDER_RADIUS['medium']};
            padding: 3px;
            selection-background-color: #E3F2FD; /* Lighter color for selection */
        }}
        QTableWidget::item:selected {{
            background-color: #E3F2FD; /* Lighter color for selection */
            color: {COLORS['text_primary']};
        }}
        QTableWidget::item:hover {{
            background-color: #F5F9FF; /* Very light color for hover */
        }}
        QHeaderView::section {{
...
# Styles for the different message types
MESSAGE_STYLES = {
    "info": f"""
        QMessageBox {{
            background-color: {COLORS["background_primary"]};
